...
-- INVENTORY TABLES
-- =====================================================================
-- Note: Matches the application model `InventoryItem` exactly.
-- Safe create and optional seeds.

-- Drop if you want a clean rebuild (optional)
...
CREATE TABLE IF NOT EXISTS `InventoryItems` (
  ...
  KEY `IX_InventoryItems_Category` (`Category`),
  KEY `IX_InventoryItems_SKU` (`SKU`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Optional seed data
INSERT INTO `InventoryItems`
  (`SKU`, `Name`, `Category`, `QuantityOnHand`, `ReorderLevel`, `UnitCost`, `UnitPrice`, `Location`, `CreatedAt`, `UpdatedAt`, `LastMovementAt`)
VALUES
  ('SKU-1001','Laser Printer','Office Equipment',12,3,199.99,249.99,'Aisle 1',NOW(),NOW(),NOW()),
  ('SKU-1002','Ink Cartridge XL','Supplies',50,20,24.50,39.99,'Aisle 2',NOW(),NOW(),NULL),
  ('SKU-1003','USB-C Cable 1m','Accessories',120,40,3.20,9.99,'Aisle 3',NOW(),NOW(),NOW()),
  ('SKU-1004','Office Chair Ergonomic','Furniture',8,2,89.00,149.00,'Aisle 4',NOW(),NOW(),NULL),
  ('SKU-1005','Monitor 27" 4K','Electronics',15,5,229.00,329.00,'Aisle 5',NOW(),NOW(),NOW());
